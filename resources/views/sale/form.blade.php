<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('Amount_Total', $sale->Amount_Total, ['class' => 'form-control' . ($errors->has('Amount_Total') ? ' is-invalid' : ''), 'placeholder' => 'Amount Total']) }}
            {!! $errors->first('Amount_Total', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('id_warehouses') }}
            {{ Form::text('id_warehouses', $sale->id_warehouses, ['class' => 'form-control' . ($errors->has('id_warehouses') ? ' is-invalid' : ''), 'placeholder' => 'Id Warehouses']) }}
